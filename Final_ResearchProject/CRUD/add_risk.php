...
if(count($_POST)>0) {
	require_once("db.php");
	$sql = "INSERT INTO RiskRegister2 (RiskName, Category, Description, Probability, ProbabilityJustification, Impact, ImpactJustification, PIValue, Priority, RiskStatus, Owner, Response, Mitigations, MitigationStatus, FinancialImpact) VALUES ('" . $_POST["RiskName"] . "','" . $_POST["Category"] . "','" . $_POST["Description"] . "','" . $_POST["Probability"] . "', '" . $_POST["ProbabilityJustification"] . "','" . $_POST["Impact"] . "', '" . $_POST["ImpactJustification"] . "','" . $_POST["PIValue"] . "','" . $_POST["Priority"] . "','" . $_POST["RiskStatus"] . "','" . $_POST["Owner"] . "','" . $_POST["Response"] . "','" . $_POST["Mitigations"] . "','" . $_POST["MitigationStatus"] . "','" . $_POST["FinancialImpact"] . "')";
