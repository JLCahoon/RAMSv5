<?php
require_once("../db.php");
$sql = "SELECT * FROM Incidents ORDER BY IncidentID DESC";
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-database"></i> Incident Log
                                </li>
                            </ol>
                        </div>
                    </div>
...
<div align="right" style="padding-bottom:5px;"><a href="add_incident.php" class="link"><img alt='Add' title='Add' src='images/add.png' width='15px' height='15px'/> Add Incident</a></div>
<table class="table" >
<tr>
<td>Incident ID</td>
<td>Incident Name</td>
...
<td><a href="edit_incident.php?IncidentID=<?php echo $row["IncidentID"]; ?>" class="link"><?php echo $row["IncidentName"]; ?></a></td>
